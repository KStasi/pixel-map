        ...
        return (
            <Card className="mb-6">
                <CardHeader className="pb-2">
                    ...
                    <CardDescription>
                        You have an active channel with{" "}
                        {wallet.channelAmount ? Number(wallet.channelAmount) / 1000000 : "0"} USDC deposited.
                    </CardDescription>
                </CardHeader>
            ...
            <CardFooter className="justify-end">
                <Button
                    className={cn(
                        ...
                        isProcessing && "bg-gray-700 text-gray-400 opacity-50 cursor-not-allowed hover:opacity-50"
                    )}
